...
<div class="main-content-w">
    ...
    <div class="main-content-i">
        ...
        if(have_posts()){
            while(have_posts()){
                have_posts();
                if(get_option('wf_single_post_navigation_type') == 'unique'){
                    if(get_adjacent_post(false,'',true)){
                        echo '<div class="post-navigation-unique">
                            <div class="post-navigation-previous">
                                <div class="arrow"><i class="fa os-icon-angle-up"></i></div>
                                <div class="caption">'.__('Previous Post', 'pluto').'</div>
                                <div class="navi-link">'.previous_post_link('%link').'</div>
                            </div>
                        </div>';
                    }
                }
                    ...
                    if(get_adjacent_post(false,'',true)){
                        echo '<div class="post-navigation-unique">
                            <div class="post-navigation-Next">
                                <div class="arrow"><i class="fa os-icon-angle-up"></i></div>
                                <div class="caption">'.__('Next Post', 'pluto').'</div>
                                <div class="navi-link">'.next_post_link('%link').'</div>
                            </div>
                        </div>';
                    }
                }
